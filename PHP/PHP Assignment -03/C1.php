<!-- 1  Write a PHP program to implement various string operations. You can take the string as first String="the LABORIOUS student” and second String="performed at his LEVEL BEST.”

  (i) Show both string in lowercase.
  (ii) Show both string in uppercase
  (iii) Convert the first letter of first string in uppercase.
  (iv) Convert the first letter of every word in upper case. Do it for both string.
  (v) Show the string whose starting word will be over.
  (vi) Replace LABORIOUS word in the first String with HARDWORKING.  -->
<?php
$firstString="the LABORIOUS student";
$secondString="performed at his LEVEL BEST.<br>";
// (i)Show both string in lowercase.

echo strtolower($firstString);
echo "<br>".strtolower($secondString);
...
echo "<br><br>".ucwords($firstString);
...
else echo "<br><Br>No any string start with over <br><br>";


// (vi) Replace quick word by super-fast word in the firstString.
echo str_replace("LABORIOUS","HARDWORKING",$firstString);
